...
/*
//Esto no funciona, no se si es por permisos o yo que se.

$directorioSubida = "archivos/";

// 1. Crear la carpeta si no existe
if (!is_dir($directorioSubida)) {
    mkdir($directorioSubida, 0777, true); // crea carpeta con permisos 777
    chmod($directorioSubida, 0777);       // asegura permisos 777
    // Si quieres cambiar propietario:
    // chown($directorioSubida, "root");
    // chgrp($directorioSubida, "root");
}
*/
