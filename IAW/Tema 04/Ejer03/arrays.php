...
//Si lo pusieramos directamente, borraría el contenido de la sesión cada vez.
...
<body>  
        ...
        echo "<input type='submit' value='Borrar Tareas Marcadas'/>";
            ...
            //echo "<p><input type='checkbox' name='borrar_tarea'>".$tarea."</p>";
